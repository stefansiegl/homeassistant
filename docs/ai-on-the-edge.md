...
**Kosten:** `sensor.gasmeter_stabil_kosten` (inkrementell Δm³ × `gaspreis_pro_m3`), Recorder. Details: [`energie-statistik-praevention.md`](./energie-statistik-praevention.md).
